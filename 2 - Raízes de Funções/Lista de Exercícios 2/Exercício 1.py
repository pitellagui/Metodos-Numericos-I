...
Estime as raízes da função f(x)=sin(4x)+cos(3x) utilizando o método gráfico,
busca incremental, bissecção e o método da falsa posição. Explique os resultados.
"""
...
for i in range(0,tam):
  ...
  xl = subintervalos[i,0]
  xu = subintervalos[i,1]
  [x, fx, Epest, iter, nn, estimativa, E_pest] = falsa_posicao(func, xl, xu, Eppara, maxit)
