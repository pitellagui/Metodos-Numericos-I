...
Use o método da falsa posição para resolver o problema do Bungee Jumping.
"""
...
def falsa_posicao(func, xl, xu, Eppara, maxit, x_ex, *args):
...
[m, fx, Epest, iter, nn, estimativa, E_pt, E_pest] = falsa_posicao(func, xl, xu, Eppara, maxit, x_ex, v, g, t, c_d)
