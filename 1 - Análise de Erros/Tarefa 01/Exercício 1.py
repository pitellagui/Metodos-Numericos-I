...
Escreva um programa para calcular e^(-5) usando as duas abordagens:
...
for i in range(0,N):
  ...
  soma = soma + serie_de_maclaurin(x,i)
  v = 1/soma
  Ept = abs((u-v)/u)*100 # Erro Percentual Verdadeiro (%)

  # Salvando os cálculos
  nn.append(k)
  estimativas.append(v)
  E_pt.append(Ept)

# Data Frame
table1 = pd.DataFrame()
table1['n'] = nn
table1['Estimativa'] = estimativas
table1['Ept (%)'] = E_pt
print(table1)
# Gráficos
